-- Configuration Supabase pour Lightspeed Integration Priority Tool
...
-- Insert integrations spécifiques à Lightspeed
...
('Komia', 'Solution d\'hygiène alimentaire - komia.io'),
...
-- Create view for integration priorities (optimisé pour le dashboard)
...
-- Enable Row Level Security (optionnel pour plus de sécurité)
ALTER TABLE integrations ENABLE ROW LEVEL SECURITY;
ALTER TABLE votes ENABLE ROW LEVEL SECURITY;

-- Politique permissive pour commencer (tu pourras restreindre plus tard)
